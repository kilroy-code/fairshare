...
### 0.11.0
- Do not version groups for now.

### 0.10.10
- New version checkpoint, with better bail for sync with wrong version.
...
### 0.8.2
- Fix failure to update notification for current group when notifications turned off.
- Log more.
...
- Fix [remember last user, group, and screen on restart](https://github.com/kilroy-code/fairshare/issues/54).
